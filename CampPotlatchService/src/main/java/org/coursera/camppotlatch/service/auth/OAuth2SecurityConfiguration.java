...
public class OAuth2SecurityConfiguration {
	...
	protected static class ResourceServer extends
		...
		public void configure(HttpSecurity http) throws Exception {
			...
			// Do not require authentication to create a new user
			/*
			http
			.authorizeRequests()
				.antMatchers("/user**")
			...
			*/
			...
			// Do require authentication and have "write" scope to query or modify a user
			/*
			http
			.authorizeRequests()
				.antMatchers("/user**")
			...
			*/
			...
			// Require all other requests to have client "write" scope
			http
			.authorizeRequests()
				.antMatchers("/**")
				.access("#oauth2.hasScope('write')");
	...
	protected static class OAuth2Config extends
		...
		public OAuth2Config() throws Exception {
			...
			UserDetailsService svc = new InMemoryUserDetailsManager(
					Arrays.asList(
							User.create("admin", "cicerre70", "ADMIN", "USER"),
							User.create("fcicerre", "Iodice16", "USER")));
			*/
			UserDetailsService svc = new PersistentUserDetailsManager(
					Arrays.asList(
							new UserAuthenticationDetails("admin", "cicerre70", "ADMIN, USER")
							//, new UserAuthenticationDetails("fcicerre", "Iodice16", "USER")
							));
